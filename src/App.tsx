...
import { ArrowDownToLine, ArrowLeft, ChevronDown, ChevronRight, Circle, Copy, Download, Eraser, FileImage, FilePlus2, FileText, FolderOpen, GripVertical, Hand, Highlighter, ImagePlus, Layers3, LayoutGrid, Maximize2, Minus, Moon, MousePointer2, PenLine, Plus, RectangleHorizontal, Redo2, Save, Search, Settings2, Sun, Trash2, Undo2, UploadCloud, X } from 'lucide-react'
